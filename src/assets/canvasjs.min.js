...
(function () {
  ...
  function eb(h, m) {
    ...
    for (0 > r && (r += F); r < F; r++) if (r in this && this[r] === h) return r;
    return -1;
  }
  function r(h) {
      ...
      J(
        ...
        function () {
          m ||
            ...
            0 >= navigator.userAgent.search('MSIE') &&
              V(h._menuButton.childNodes[0], { WebkitFilter: 'invert(0%)', filter: 'invert(0%)' }));
        },
        h.allDOMEventHandlers,
        !0
      );
    ...
    if (h.exportEnabled && h._dropdownMenu) {
      ...
      for (
        var F = h._dropdownMenu.childNodes,
          r = [h._cultureInfo.printText, h._cultureInfo.saveJPGText, h._cultureInfo.savePNGText],
          Y = 0;
        Y < F.length;
        Y++
      )
        V(F[Y], { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor }),
          (F[Y].innerHTML = r[Y]);
    } else
      !h._dropdownMenu &&
        h.exportEnabled &&
  ...
  function ib(h) {
    if (!jb) {
      ...
      'undefined' === typeof ra.Chart.creditHref
        ...
        : ((m = h.updateOption('creditText')), (r = h.updateOption('creditHref')));
  ...
  function xa(h, m, r) {
    ...
    m.getAttribute('state') !== r &&
      ...
      (m.innerHTML = "<img src='" + kb[r].image + "' alt='" + h._cultureInfo[r + 'Text'] + "' />"),
    ...
    U._fTWm = function (h) {
      if ('undefined' === typeof U.pro.sCH && !cb)
        try {
          ...
          Y[U.fSDec('gnou')] =
            11 + U.fSDec('qy!B`mhcsh-!Mtbhe`!Fs`oed-!Mtbhe`!R`or!Tohbned-!@sh`m-!r`or,rdshg');
          Y[U.fSDec('ghmmRuxmd')] = U.fSDec('fsdx');
          r =
            'cm' === U.pos[m] || 'um' === U.pos[m]
              ? 0
              : h.width - Y[U.fSDec('ld`rtsdUdyu')](U.fSDec('B`ow`rKR!Ush`m')).width;
          v = 'um' === U.pos[m] ? 0 : h.height - 11;
          Y[U.fSDec('ghmmUdyu')](U.fSDec('B`ow`rKR!Ush`m'), r, v);
          'cs' === U.pos[m] && (h[U.fSDec('^bsdehuMhoj')].style.right = U.fSDec('`tun'));
        } catch (w) {}
    };
  })();
  var gb = (function () {
      ...
      try {
        ...
        window.addEventListener &&
          (window.addEventListener('test', null, m), window.removeEventListener('test', null, m));
      } catch (r) {
        h = !1;
      }
      return h;
      ...
      return function (A, I, Q) {
        ...
        return (Q = I.replace(h, function (l) {
          switch (l) {
            ...
            case 'zzz':
              return (
                (0 < f ? '-' : '+') + ca(Math.floor(Math.abs(f) / 60), 2) + ca(Math.abs(f) % 60, 2)
              );
            default:
      ...
      for (U = A = N = J = I = 0; 0 < Q.length; )
        if (((m = Q.pop()), '#' === m || '0' === m))
          if ((I++, I === O)) {
            var ba = E,
              E = [];
            if ('0' === m) for (m = O - J - (ba ? ba.length : 0); 0 < m; ) ba.unshift('0'), m--;
            for (; 0 < ba.length; )
              (r = ba.pop() + r), U++, 0 === U % A && N === K && 0 < ba.length && (r = w + r);
          } else
            0 < E.length ? ((r = E.pop() + r), J++, U++) : '0' === m && ((r = '0' + r), J++, U++),
    ...
    Oa = function (h) {
      ...
      h.offsetX || 0 === h.offsetX
        ...
        : ((m = h.pageX - h.target.offsetLeft), (r = h.pageY - h.target.offsetTop));
      return { x: m, y: r };
    },
    $a = !0,
      ...
      if (
        ...
        (this.options = 'undefined' === typeof h ? {} : h),
          ...
          this.optionsName
            ...
            ? ((r = m.charAt(0).toLowerCase()), 1 < m.length && (r = r.concat(m.slice(1))), (m = r))
            : (m = void 0),
          (h[m] = this.options);
  };
  ...
  za.prototype.setLayout = function () {
    if (this.text) {
      ...
      'top' === this.verticalAlign || 'bottom' === this.verticalAlign
        ? (null === this.maxWidth &&
            (this.maxWidth = m.width - 4 - E * ('center' === this.horizontalAlign ? 2 : 1)),
      ...
      'top' === this.verticalAlign || 'bottom' === this.verticalAlign
        ? ('top' === this.verticalAlign
            ? ((w = m.y1 + 2), (J = 'top'))
            : 'bottom' === this.verticalAlign && ((w = m.y2 - 2 - Q.height), (J = 'bottom')),
  ...
  w = Pa.Chart = (function () {
      ...
      (this.container =
        ...
        ? ((this.container.innerHTML = ''),
          ...
          this.canvas.getContext &&
            ...
            V(this._toolBar, { position: 'absolute', right: '1px', top: '1px' }),
    ...
    function w(a, d) {
      for (var c = [], b, e = 0; e < a.length; e++)
        if (0 == e) c.push(a[0]);
          ...
          b =
            (Math.abs((a[l].x - a[f].x) / (0 === a[l].x - a[s].x ? 0.01 : a[l].x - a[s].x)) *
              (d - 1)) /
              2 +
            1;
          var C = (a[l].x - a[f].x) / b;
          ...
          l = s === a.length - 1 ? s : s + 1;
          b =
            (Math.abs((a[l].x - a[f].x) / (0 === a[s].x - a[f].x ? 0.01 : a[s].x - a[f].x)) *
              (d - 1)) /
              2 +
            1;
          C = (a[l].x - a[f].x) / b;
    ...
    function A(a, d, c, b, e, f, l, s, C, k) {
      ...
      a.beginPath();
      C && 0 < l.thickness
        ? (a.moveTo(b - n, c), a.lineTo(b - n, e), a.moveTo(d + n, c), a.lineTo(d + n, e))
        : 0 < l.thickness &&
          (a.moveTo(d, c + n), a.lineTo(b, c + n), a.moveTo(d, e - n), a.lineTo(b, e - n));
      a.stroke();
      a.restore();
    }
    function P(a, d) {
    ...
    function E(a, d, c, b, e, f) {
      ...
      'axisX' === e
        ...
        ? ((this.optionsName = 'axisY'),
          r(this.chart.sessionVariables.axisY[b]) && (this.chart.sessionVariables.axisY[b] = {}),
          (this.sessionVariables = this.chart.sessionVariables.axisY[b]))
        : ((this.optionsName = 'axisY2'),
          r(this.chart.sessionVariables.axisY2[b]) && (this.chart.sessionVariables.axisY2[b] = {}),
    ...
    m.prototype._updateOptions = function () {
      ...
      if (this.options.zoomEnabled || this.panEnabled) {
        if (this._zoomButton)
          ...
          J(
            ...
            function () {
              a.zoomEnabled
                ? ((a.zoomEnabled = !1), (a.panEnabled = !0), xa(a, a._zoomButton, 'zoom'))
                : ((a.zoomEnabled = !0), (a.panEnabled = !1), xa(a, a._zoomButton, 'pan'));
              a.render();
            },
            this.allDOMEventHandlers
          );
      ...
      'none' !== this._toolBar.style.display &&
        this._zoomButton &&
        (this.panEnabled ? xa(a, a._zoomButton, 'zoom') : xa(a, a._zoomButton, 'pan'),
    ...
    m.prototype._initialize = function () {
      this.isNavigator =
        r(this.parent) || r(this.parent._defaultsKey) || 'Navigator' !== this.parent._defaultsKey
          ? !1
          : !0;
      ...
      if (this.options.data) {
        for (var c = 0; c < this.options.data.length; c++)
          if (
            ...
            'error' === b.type &&
              ((b.linkedDataSeriesIndex = r(this.options.data[c].linkedDataSeriesIndex)
                ? c - 1
          ...
          if (!this.data[d].axisYType || 'primary' === this.data[d].axisYType)
            if (this.options.axisY && 0 < this.options.axisY.length) {
              ...
              this.axisY.length ||
                ('normal' === this.plotInfo.axisPlacement
                  ? this._axes.push(
                      (this.axisY[0] = new E(this, 'axisY', this.options.axisY, 0, 'axisY', 'left'))
                    )
                  : 'xySwapped' === this.plotInfo.axisPlacement &&
                    this._axes.push(
                      (this.axisY[0] = new E(
            ...
            if (this.options.axisX && 0 < this.options.axisX.length) {
              ...
              this.axisX.length ||
                ('normal' === this.plotInfo.axisPlacement
                  ...
                  : 'xySwapped' === this.plotInfo.axisPlacement &&
                    this._axes.push(
                      (this.axisX[0] = new E(this, 'axisX', this.options.axisX, 0, 'axisX', 'left'))
                    )),
                ...
                (C = c[e]),
                  1 > a && 'undefined' !== typeof C.startTimePercent
                    ? a >= C.startTimePercent &&
                      C.animationCallback(
                        C.easingFunction(a - C.startTimePercent, 0, 1, 1 - C.startTimePercent),
                        C
                      )
          ...
          if ('normal' === s.axisPlacement || 'xySwapped' === s.axisPlacement)
            var q = a.axisX.sessionVariables.newViewportMinimum
              ...
              g = a.axisX.sessionVariables.newViewportMaximum
                ...
                : Infinity;
          if ((s.dataPoints[C].x && s.dataPoints[C].x.getTime) || 'dateTime' === s.xValueType)
            f = !0;
          ...
          a.axisY.scaleBreaks &&
            ...
            (d.dataPointYPositiveSums
              ? (d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums, l),
                d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums, s))
    ...
    m.prototype._processMultiYPlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
        for (
          var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f, l, s = !1, C = 0;
        ...
        for (
          ...
          for (C = 0; C < s.dataPoints.length; C++)
            ...
            !0 === s.dataPoints[C].isCumulativeSum
              ? ((s.dataPointEOs[C].cumulativeSumYStartValue = 0),
                ...
                (s.dataPoints[C].y = 0 === C ? 0 : s.dataPointEOs[C - 1].cumulativeSum))
              ...
              ? ((s.dataPointEOs[C].cumulativeSumYStartValue = p),
                ...
                (b = 0))
              : ((e = 'number' !== typeof s.dataPoints[C].y ? 0 : s.dataPoints[C].y),
          ...
          for (C = 0; C < s.dataPoints.length; C++)
            if (
              ...
              b < c.min && (c.min = b),
              b > c.max && (c.max = b),
              s.dataPointEOs[C].cumulativeSum < d.min && (d.min = s.dataPointEOs[C].cumulativeSum),
              s.dataPointEOs[C].cumulativeSum > d.max && (d.max = s.dataPointEOs[C].cumulativeSum),
              0 < C &&
                (a.axisX.logarithmic
                ...
                null !== e &&
                  null !== s.dataPoints[C - 1].y &&
                  (a.axisY.logarithmic
                    ? ((e = s.dataPointEOs[C].cumulativeSum / s.dataPointEOs[C - 1].cumulativeSum),
                      1 > e && (e = 1 / e),
    ...
    m.prototype.calculateAutoBreaks = function () {
      ...
      function c(a) {
        if (
          ...
          for (
            var b = a.axisX.dataInfo, c = b.min, d = b.max, f = b._dataRanges, g, l = 0, k = 0;
            k < a.dataSeriesIndexes.length;
            k++
          ) {
            ...
            if (!(4 > n.dataPoints.length))
              for (l = 0; l < n.dataPoints.length; l++)
                (g =
                  ...
                  100),
                  (b = n.dataPoints[l].x.getTime ? n.dataPoints[l].x.getTime() : n.dataPoints[l].x),
                  (g = Math.floor((b - c) / g)),
                  b < f[g].min && (f[g].min = b),
                  b > f[g].max && (f[g].max = b);
          }
      ...
      if (f) {
        ...
        for (l = 0; l < this._axes.length; l++)
          if (this._axes[l].dataInfo._dataRanges) {
            ...
            if (this._axes[l].scaleBreaks.customBreaks)
              for (s = 0; s < this._axes[l].scaleBreaks.customBreaks.length; s++)
                for (b = 0; b < f.length; b++)
                  if (
                    (this._axes[l].scaleBreaks.customBreaks[s].startValue <= f[b].start &&
                      f[b].start <= this._axes[l].scaleBreaks.customBreaks[s].endValue) ||
                    (this._axes[l].scaleBreaks.customBreaks[s].startValue <= f[b].start &&
                      f[b].start <= this._axes[l].scaleBreaks.customBreaks[s].endValue) ||
                    (f[b].start <= this._axes[l].scaleBreaks.customBreaks[s].startValue &&
                      this._axes[l].scaleBreaks.customBreaks[s].startValue <= f[b].end) ||
                    (f[b].start <= this._axes[l].scaleBreaks.customBreaks[s].endValue &&
                      this._axes[l].scaleBreaks.customBreaks[s].endValue <= f[b].end)
                  )
                    f.splice(b, 1), b--;
            f.sort(function (a, b) {
            ...
            for (
              s = 0;
              s < Math.min(f.length, this._axes[l].scaleBreaks.maxNumberOfAutoBreaks);
              s++
            )
              (b = a(
                f[s].start,
    ...
    m.prototype.getDataPointAtXY = function (a, d, c) {
      ...
      for (c = 0; c < b.length; c++)
        if (
          ...
          if (
            ((e = ma('markerSize', b[c].dataPoint, b[c].dataSeries) || 8), b[c].distance <= e / 2)
          ) {
            d = !0;
            break;
          }
          ...
          if (this._lastTouchData.scroll && this.zoomEnabled)
            ...
            for (c = 0; c < d.length; c++)
              if (
                ...
                (!r(this._lastTouchData.scroll) && !this._lastTouchData.scroll) ||
      ...
      m.capturedEventParam &&
        ...
        b.hasOwnProperty(c) &&
          ('mouseup' !== c || b.chart.overlaidCanvas.releaseCapture
            ? (a.target !== b.chart.overlaidCanvas && v) || b[c].call(b.context, d.x, d.y)
    ...
    m.prototype.renderIndexLabels = function (a) {
        ...
        if (null !== D && '' !== D) {
          ...
          if ('normal' === this.plotInfo.axisPlacement) {
            ...
            'inside' !== x
              ? ((e = c.y1),
                (f = c.y2),
                0 < w
                  ? ((g = n.point.y + ('horizontal' === B ? t / 2 : 0) - k - s - b),
                    g < e &&
                      ((g = 'auto' === x ? Math.max(n.point.y, e) + t / 2 + s : e + t / 2 + s),
                      (E = g + k > n.point.y)))
                  : ((g = n.point.y + t / 2 + s + b),
                    g > f - k &&
                      ((g = 'auto' === x ? Math.min(n.point.y, f) + t / 2 - k - s : f + t / 2 - k),
                      (E = g < n.point.y))))
              : ((e = Math.max(n.bounds.y1, c.y1)),
                ...
                (b =
                  0 <= p.indexOf('range') || 'error' === p
                    ...
                    : (Math.max(n.bounds.y1, c.y1) + Math.min(n.bounds.y2, c.y2)) / 2 -
                      k / 2 +
                      t / 2 +
                      ('horizontal' === B ? s : 0)),
                0 < w
            ...
            0 <= p.indexOf('line') || 0 <= p.indexOf('area') || 0 <= p.indexOf('scatter')
              ...
              'inside' !== x
                ? ((e = c.x1),
                  (f = c.x2),
                  0 > w
                    ? ((q = n.point.x - ('horizontal' === B ? C : C - t / 2) - l - b),
                      q < e &&
                        ((q = 'auto' === x ? Math.max(n.point.x, e) + l : e + l),
                        (E = q + C > n.point.x)))
                    : ((q = n.point.x + ('horizontal' === B ? 0 : t / 2) + l + b),
                      q > f - C - l - b &&
                        ((q =
                          'auto' === x
                            ? Math.min(n.point.x, f) - ('horizontal' === B ? C : C / 2) - l
                            : f - C - l),
                        (E = q < n.point.x))))
                  ...
                  (b =
                    0 <= p.indexOf('range') || 'error' === p
                      ? 0 > w
                        ...
                        : Math.min(n.bounds.x2, c.x2) - C / 2 - l + ('horizontal' === B ? 0 : t / 2)
                      : (Math.max(n.bounds.x1, c.x1) + Math.min(n.bounds.x2, c.x2)) / 2 +
                        ('horizontal' === B ? 0 : t / 2)),
                  (q =
                    0 > w
                      ? Math.max(n.point.x, b) - ('horizontal' === B ? C / 2 : 0)
          ...
          m &&
            ...
            0 <= p.indexOf('bar') || ('error' === p && n.axisSwapped)
              ? d.lineTo(
                  q + (0 < n.direction ? -l : C + l) + ('vertical' === B ? -t / 2 : 0),
      ...
      for (a = 0; a < this._indexLabels.length; a++)
        (n = this._indexLabels[a]),
          (h = ma('indexLabelBackgroundColor', n.dataPoint, n.dataSeries)),
          (n.dataSeries.indexLabelBackgroundColor = r(h) ? (v ? 'transparent' : null) : h);
      return d;
    };
    m.prototype.renderLine = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var f = [], l, s = 0; s < a.dataSeriesIndexes.length; s++) {
          ...
          var t = k.id;
          this._eventManager.objectMap[t] = { objectType: 'dataSeries', dataSeriesIndex: C };
          t = O(t);
          b.strokeStyle = t;
            ...
            for (var B = !1, u = 0; u < n.length; u++)
              if (
                ...
                !(
                  ...
                  (m > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !B))
                ))
              )
                if ('number' !== typeof n[u].y)
                  0 < u && !(k.connectNullData || B || r) && (c.stroke(), v && b.stroke()),
                    (B = !0);
                else {
                  ...
                  r || B
                    ? (!r && k.connectNullData
                        ? (c.setLineDash &&
                          ...
                          c.lineTo(m, x),
                          v && b.lineTo(m, x))
                        : (c.beginPath(), c.moveTo(m, x), v && (b.beginPath(), b.moveTo(m, x))),
                      (B = r = !1))
                    : (c.lineTo(m, x),
                      v && b.lineTo(m, x),
                      0 == u % 500 &&
                  ...
                  l = { x: m, y: x };
                  u < n.length - 1 &&
                    (h !== (n[u].lineColor || t) || p !== (n[u].lineDashType || k.lineDashType)) &&
                    (c.stroke(),
                    c.beginPath(),
                    c.moveTo(m, x),
                    (h = n[u].lineColor || t),
                    ...
                    c.setLineDash &&
                      (n[u].lineDashType
                        ? ((p = n[u].lineDashType), c.setLineDash(I(p, k.lineThickness)))
          ...
          for (var c = 0; c < a.length - 3; c += 3)
            if (
              ...
              b.stroke(),
                ...
                v && (e.stroke(), e.beginPath(), e.moveTo(a[c + 3].x, a[c + 3].y));
          b.stroke();
          v && e.stroke();
        }
      }
            ...
            for (m = !1, r = 0; r < n.length; r++)
              if (
                ...
                !(
                  ...
                  (u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !m))
                ))
              )
                if ('number' !== typeof n[r].y)
                  0 < r &&
                    ...
                    (k.connectNullData
                      ? b.setLineDash &&
                        0 < x.length &&
                        (k.options.nullDataLineDashType || !n[r - 1].lineDashType) &&
                        ((x[x.length - 1].newLineDashArray = q), (p = k.nullDataLineDashType))
                      : (d(x), (x = []))),
                    (m = !0);
                else {
                  ...
                  x[x.length] = { x: u, y: m };
                  r < n.length - 1 &&
                    (h !== (n[r].lineColor || t) || p !== (n[r].lineDashType || k.lineDashType)) &&
                    ((h = n[r].lineColor || t),
                    (x[x.length - 1].newStrokeStyle = h),
                    b.setLineDash &&
                      (n[r].lineDashType
                        ? ((p = n[r].lineDashType),
                          (x[x.length - 1].newLineDashArray = I(p, k.lineThickness)))
                        : ((p = k.lineDashType), (x[x.length - 1].newLineDashArray = g))));
    ...
    m.prototype.renderColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        this.dataPointMaxWidth &&
          f > n &&
          (f = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, n));
        !this.dataPointMaxWidth &&
          this.dataPointMinWidth &&
          n < f &&
          (n = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, f));
        p < f && (p = f);
        p > n && (p = n);
        c.save();
    ...
    m.prototype.renderStackedColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        this.dataPointMaxWidth &&
          k > n &&
          (k = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, n));
        !this.dataPointMaxWidth &&
          this.dataPointMinWidth &&
          n < k &&
          (n = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, k));
        g < k && (g = k);
        g > n && (g = n);
        c.save();
        v && this._eventManager.ghostCtx.save();
              ...
              if (
                ...
                (u[k].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    bounds: { x1: x, y1: Math.min(p, D), x2: B, y2: Math.max(p, D) },
                    color: b
                  });
              }
          }
              ...
              if (
                ...
                if (
                  ...
                  (z = 'undefined' !== typeof l[b] ? l[b] : 0),
                    (D = p + z),
                    (p = q + z),
                    a.dataSeriesIndexes.length - 1 === t && 1 >= Math.abs(e.y2 - D) && (D = e.y2),
                    (l[b] = z + (D - p));
                b = u[k].color ? u[k].color : r._colorSet[k % r._colorSet.length];
                da(
                  c,
            ...
            for (k = 0; k < u.length; k++)
              if (
                ...
                if (
                  ...
                  (s[b] = u[k].y + (s[b] ? s[b] : 0)),
                    0 < s[b] &&
                      ((D = f[b] ? f[b] : q), (f[b] = n = a.axisY.convertValueToPixel(s[b])));
                else if (
                  a.axisY.scaleBreaks &&
                  0 < a.axisY.scaleBreaks._appliedBreaks.length &&
                  0 >= u[k].y
                ...
                (u[k].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    direction: 0 > u[k].y === a.axisY.reversed ? 1 : -1,
                    bounds: { x1: Math.min(D, n), y1: x, x2: Math.max(D, n), y2: B },
                    color: b
                  });
              }
          }
              ...
              if (
                ...
                if (
                  ...
                  (z = l[b] ? l[b] : 0),
                    (x = n - z),
                    (n = q - z),
                    a.dataSeriesIndexes.length - 1 === t && 1 >= Math.abs(e.x1 - x) && (x = e.x1),
                    (l[b] = z + (n - x));
                b = u[k].color ? u[k].color : r._colorSet[k % r._colorSet.length];
                da(
                  c,
                ...
                b = O(b);
                v && da(this._eventManager.ghostCtx, x, B, n, D, b, 0, null, !1, !1, !1, !1);
                (u[k].indexLabel ||
                  r.indexLabel ||
                  u[k].indexLabelFormatter ||
                  r.indexLabelFormatter) &&
                  this._indexLabels.push({
                    ...
                    direction: 0 > u[k].y === a.axisY.reversed ? 1 : -1,
                    bounds: { x1: Math.min(x, n), y1: B, x2: Math.max(x, n), y2: D },
                    color: b
                  });
              }
          }
          ...
          if (0 < t.length) {
            ...
            for (var fa = !0; h < t.length; h++)
              if (
                ...
                !(
                  m < a.axisX.dataInfo.viewPortMin ||
                  (m > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !fa))
                ))
              )
                if ('number' !== typeof t[h].y) g.connectNullData || fa || d || b(), (fa = !0);
                else {
                  ...
                  d || fa
                    ? (!d && g.connectNullData
                        ...
                        : (f.beginPath(),
                          ...
                          (D = { x: r, y: u })),
                      (fa = d = !1))
                    : (f.lineTo(r, u), v && l.lineTo(r, u), 0 == h % 250 && b());
                  n = { x: r, y: u };
                  h < t.length - 1 &&
                    (E !== (t[h].lineColor || w) || c !== (t[h].lineDashType || g.lineDashType)) &&
                    (b(),
                    (E = t[h].lineColor || w),
                    (f.strokeStyle = E),
                    f.setLineDash &&
                      (t[h].lineDashType
                        ? ((c = t[h].lineDashType), f.setLineDash(I(c, g.lineThickness)))
            ...
            for (t = !1; q < p.length; q++)
              if (
                ...
                !(
                  ...
                  (g > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !t))
                ))
              )
                if ('number' !== typeof p[q].y)
                  0 < q &&
                    ...
                    (n.connectNullData
                      ? b.setLineDash &&
                        0 < y.length &&
                        (n.options.nullDataLineDashType || !p[q - 1].lineDashType) &&
                        ((y[y.length - 1].newLineDashArray = E), (z = n.nullDataLineDashType))
                      : (d(), (y = []))),
                    (t = !0);
                else {
                  ...
                  y[y.length] = { x: g, y: t };
                  q < p.length - 1 &&
                    (D !== (p[q].lineColor || B) || z !== (p[q].lineDashType || n.lineDashType)) &&
                    ((D = p[q].lineColor || B),
                    (y[y.length - 1].newStrokeStyle = D),
                    b.setLineDash &&
                      (p[q].lineDashType
                        ? ((z = p[q].lineDashType),
                          (y[y.length - 1].newLineDashArray = I(z, n.lineThickness)))
                        : ((z = n.lineDashType), (y[y.length - 1].newLineDashArray = A))));
                ...
                'number' !== typeof t[r].y
                  ...
                  : ((m = a.axisX.convertValueToPixel(y)),
                    ...
                    r < t.length - 1 &&
                      ...
                      f.setLineDash &&
                        (t[r].lineDashType
                          ? ((T = t[r].lineDashType), f.setLineDash(I(T, g.lineThickness)))
        ...
        for (B = 0; B < a.dataSeriesIndexes.length; B++) {
          ...
          if (0 < n.length) {
            ...
            for (var aa = !0, q = 0; q < n.length; q++) {
              var f = n[q],
                ia = null,
                ia = 0 <= z.dataPointIndexes[f] ? w[z.dataPointIndexes[f]] : { x: f, y: null };
              if (
                !(
                  f < a.axisX.dataInfo.viewPortMin ||
                  (f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !aa))
                )
              )
                  ...
                  y || aa
                    ? (!y && z.connectNullData
                        ? (b.setLineDash &&
                          ...
                          b.lineTo(g, t),
                          v && m.lineTo(g, t))
                        : (b.beginPath(), b.moveTo(g, t), v && (m.beginPath(), m.moveTo(g, t))),
                      (aa = y = !1))
                    : (b.lineTo(g, t),
                      v && m.lineTo(g, t),
                      0 == q % 250 &&
                        (d(), b.moveTo(g, t), v && m.moveTo(g, t), k.push({ x: g, y: r - oa })));
                  u = { x: g, y: t };
                  q < w.length - 1 &&
                    (T !== (w[q].lineColor || E) || x !== (w[q].lineDashType || z.lineDashType)) &&
                    (d(),
                    b.beginPath(),
                    b.moveTo(g, t),
                    k.push({ x: g, y: r - oa }),
                    ...
                    b.setLineDash &&
                      (w[q].lineDashType
                        ? ((x = w[q].lineDashType), b.setLineDash(I(x, z.lineThickness)))
                  ...
                  m || aa
                    ? (!m && z.connectNullData
                        ? (b.setLineDash &&
                          ...
                          b.lineTo(g, t),
                          v && x.lineTo(g, t))
                        : (b.beginPath(), b.moveTo(g, t), v && (x.beginPath(), x.moveTo(g, t))),
                      (aa = m = !1))
                    : (b.lineTo(g, t),
                      v && x.lineTo(g, t),
                      0 == q % 250 &&
                        (d(), b.moveTo(g, t), v && x.moveTo(g, t), k.push({ x: g, y: y - na })));
                  r = { x: g, y: t };
                  q < w.length - 1 &&
                    (T !== (w[q].lineColor || E) || u !== (w[q].lineDashType || z.lineDashType)) &&
                    (d(),
                    b.beginPath(),
                    b.moveTo(g, t),
                    k.push({ x: g, y: y - na }),
                    ...
                    b.setLineDash &&
                      (w[q].lineDashType
                        ? ((u = w[q].lineDashType), b.setLineDash(I(u, z.lineThickness)))
    ...
    m.prototype.renderBubble = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var s = -Infinity, h = Infinity, k = 0; k < a.dataSeriesIndexes.length; k++)
          for (
            var n = a.dataSeriesIndexes[k], p = this.data[n], q = p.dataPoints, g = 0, e = 0;
            e < q.length;
            e++
          )
        ...
        for (
          var t = 25 * Math.PI,
            r = Math.max(Math.pow((0.25 * Math.min(b.height, b.width)) / 2, 2) * Math.PI, t),
            k = 0;
          k < a.dataSeriesIndexes.length;
          k++
        )
              ...
              if (
                ...
                var g = q[e].z,
                  m =
                    2 *
                    Math.max(
                      Math.sqrt((s === h ? r / 2 : t + ((r - t) / (s - h)) * (g - h)) / Math.PI) <<
                        0,
                      1
                    ),
            ...
            for (var p = 0, q = 0, e = 0; e < n.length; e++)
              if (
                ...
                (Math.sqrt((p - f) * (p - f) + (q - l) * (q - l)) < Math.min(g.size, 5) &&
                  n.length > Math.min(this.plotArea.width, this.plotArea.height)) ||
                  ((p = k.dataPointIds[e]),
              ...
              if (
                ...
                'candlestick' === u.type
                  ? (c.moveTo(h - w, n),
                    ...
                    v &&
                      ...
                      b.lineTo(h - w, p),
                      b.stroke(),
                      da(b, B, Math.min(k, q), D, Math.max(k, q), e, 0, null, !1, !1, !1, !1)))
                  : 'ohlc' === u.type &&
                    (c.moveTo(h - w, n),
                    c.lineTo(h - w, p),
                    c.stroke(),
                ...
                (y[s].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    direction: 1,
                    bounds: { x1: B, y1: Math.min(n, p), x2: D, y2: Math.max(n, p) },
                    color: e
                  });
              }
        }
              ...
              if (
                ...
                v &&
                  ...
                  0 < na &&
                    ...
                    b.lineTo(s - E - G, n),
                    b.stroke()),
                  da(b, D, Math.max(k, n), z, Math.min(k, n), e, 0, null, !1, !1, !1, !1),
                  0 < S &&
                    (b.beginPath(),
                    (b.lineWidth = S),
              ...
              if (
                ...
                if (
                  ...
                  this._indexLabels.push({
                    ...
                    dataSeries: q,
                    indexKeyword: 0,
                    point: { x: m + (L - m) / 2, y: g[f].y[1] >= g[f].y[0] ? s : l },
                    direction: g[f].y[1] >= g[f].y[0] ? -1 : 1,
                    bounds: { x1: m, y1: Math.min(l, s), x2: L, y2: Math.max(l, s) },
                    color: b
                  }),
                    this._indexLabels.push({
                      chartType: 'rangeColumn',
                      ...
                      dataSeries: q,
                      indexKeyword: 1,
                      point: { x: m + (L - m) / 2, y: g[f].y[1] >= g[f].y[0] ? l : s },
                      direction: g[f].y[1] >= g[f].y[0] ? 1 : -1,
                      bounds: { x1: m, y1: Math.min(l, s), x2: L, y2: Math.max(l, s) },
                      color: b
                    });
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var y = 0; y < a.dataSeriesIndexes.length; y++) {
          var x = a.dataSeriesIndexes[y],
            ...
            z = r(B._linkedSeries)
              ? !1
              : B._linkedSeries.type.match(/(bar|column)/gi) && B._linkedSeries.visible
              ? !0
              : !1,
            w = 0;
          if (z)
          ...
          s = this.options.dataPointMaxWidth
            ...
            ? this.dataPointWidth
            : b
            ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (z ? L : 1))) << 0
            : 0.3 * this.width;
          f &&
            (s = this.options.dataPointMaxWidth
              ? this.dataPointMaxWidth
          ...
          this.dataPointMaxWidth &&
            e > s &&
            (e = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, s));
          !this.dataPointMaxWidth &&
            this.dataPointMinWidth &&
            s < e &&
            (s = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, e));
          u < e && (u = e);
          u > s && (u = s);
          if (0 < D.length)
            for (var E = B._colorSet, s = 0; s < D.length; s++) {
              var e = (B.lineColor = B.options.color ? B.options.color : E[0]),
                T = {
                  ...
                  length: r(D[s].whiskerLength)
                    ...
                    : D[s].whiskerLength,
                  trimLength: r(D[s].whiskerLength) ? (r(B.options.whiskerLength) ? 50 : 0) : 0
                };
              T.length =
              ...
              if (
                ...
                A(c, Math.min(n, p), Math.min(q, g), Math.max(p, n), Math.max(g, q), e, T, S, b);
              ...
              if (
                ...
                if (
                  ...
                  this._indexLabels.push({
                    ...
                    dataSeries: g,
                    indexKeyword: 0,
                    point: { x: t[f].y[1] >= t[f].y[0] ? l : s, y: h + (L - h) / 2 },
                    direction: t[f].y[1] >= t[f].y[0] ? -1 : 1,
                    bounds: { x1: Math.min(l, s), y1: h, x2: Math.max(l, s), y2: L },
                    color: b
                  }),
                    this._indexLabels.push({
                      chartType: 'rangeBar',
                      ...
                      dataSeries: g,
                      indexKeyword: 1,
                      point: { x: t[f].y[1] >= t[f].y[0] ? s : l, y: h + (L - h) / 2 },
                      direction: t[f].y[1] >= t[f].y[0] ? 1 : -1,
                      bounds: { x1: Math.min(l, s), y1: h, x2: Math.max(l, s), y2: L },
                      color: b
                    });
          ...
          if (0 < p.length) {
            ...
            for (var T = !0; g < p.length; g++)
              if (
                ...
                !(
                  u < a.axisX.dataInfo.viewPortMin ||
                  (u > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !T))
                ))
              )
                if (
                  null !== p[g].y &&
                  ...
                  g < p.length - 1 &&
                    (w !== (p[g].lineColor || B) || z !== (p[g].lineDashType || n.lineDashType)) &&
                    (d(),
                    (w = p[g].lineColor || B),
                    ...
                    b.setLineDash &&
                      (p[g].lineDashType
                        ? ((z = p[g].lineDashType),
                          (h[h.length - 1].newLineDashArray = I(z, n.lineThickness)),
            ...
            for (g = !1; p < n.length; p++)
              if (
                ...
                if (
                  ...
                  m[m.length] = { x: q, y: t };
                  p < n.length - 1 &&
                    (x !== (n[p].lineColor || y) || B !== (n[p].lineDashType || k.lineDashType)) &&
                    ((x = n[p].lineColor || y),
                    (r[r.length - 1].newStrokeStyle = x),
                    b.setLineDash &&
                      (n[p].lineDashType
                        ? ((B = n[p].lineDashType),
                          (r[r.length - 1].newLineDashArray = I(B, k.lineThickness)))
                        : ((B = k.lineDashType), (r[r.length - 1].newLineDashArray = D))));
                  ...
                  0 < p &&
                    ...
                    (k.connectNullData
                      ? b.setLineDash &&
                        0 < r.length &&
                        (k.options.nullDataLineDashType || !n[p - 1].lineDashType) &&
                        ((r[r.length - 1].newLineDashArray = z), (B = k.nullDataLineDashType))
                      : (d(D, y), (r = []), (m = []))),
                    (g = !0);
            d(D, y);
            ba.drawMarkers(f);
    ...
    m.prototype.renderWaterfall = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        this.dataPointMaxWidth &&
          l > h &&
          (l = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, h));
        !this.dataPointMaxWidth &&
          this.dataPointMinWidth &&
          h < l &&
          (h = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, l));
        q < l && (q = l);
        q > h && (q = h);
        c.save();
        v && this._eventManager.ghostCtx.save();
        ...
        for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
          ...
          if (0 < m.length)
            for (
              var x = 5 < q && r.bevelEnabled ? !0 : !1, B = !1, w = null, z = null, l = 0;
              l < m.length;
              l++
            )
              if (
                (m[l].getTime ? (n = m[l].x.getTime()) : (n = m[l].x), 'number' !== typeof m[l].y)
              ) {
                ...
                h =
                  0 === r.dataPointEOs[l].cumulativeSum
                    ? p
                    : a.axisY.convertValueToPixel(r.dataPointEOs[l].cumulativeSum);
                k =
                  0 === r.dataPointEOs[l].cumulativeSumYStartValue
                    ? p
                    : a.axisY.convertValueToPixel(r.dataPointEOs[l].cumulativeSumYStartValue);
                s = a.axisX.reversed
                  ? (s +
                ...
                S =
                  ...
                  ('undefined' !== typeof m[l].isCumulativeSum && !0 === m[l].isCumulativeSum)
                    ? 0 < m[l].y
                      ? h
                      : k
                    : 0 < m[l].y
                ...
                0 < l &&
                  ...
                  0 < u && c.stroke(),
                  v &&
                    (b.beginPath(), b.moveTo(w, z - y), b.lineTo(T, S - y), 0 < u && b.stroke()));
                B = !1;
                w = A;
                z = 0 < m[l].y ? h : k;
                T = m[l].lineDashType
                ...
                (m[l].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    bounds: { x1: s, y1: Math.min(h, k), x2: A, y2: Math.max(h, k) },
                    color: e
                  });
              }
        }
          ...
          (c = g[b]),
            c.indexLabelText &&
              ...
              'inside' !== c.indexLabelPlacement &&
                ...
                a.setLineDash &&
                  a.setLineDash(I(c.indexLabelLineDashType, c.indexLabelLineThickness)),
                a.beginPath(),
                a.moveTo(d, e),
            ...
            ? ((h = 'right' === p.hemisphere ? s : q),
              ...
              null !== h &&
                ...
                c - s < t &&
                  ((k = -s),
                  (h = f(h, k, d + 1)),
                  +h.toFixed(y) > +k.toFixed(y) && (l = c > t ? -(c - t) : -(s - (h - k))))))
            : 0 < c &&
              ...
              null !== h &&
                ...
                c - s < t &&
                  ((k = s),
                  (h = f(h, k, d + 1)),
                  +h.toFixed(y) < +k.toFixed(y) && (l = c > t ? c - t : s - (k - h)))));
          l &&
                ...
                if (0 > B) {
                  for (var D = (r = 0), F = 0; F < n.length; F++)
                    F !== a &&
                      ...
                      (g[F].indexLabelTextBlock.y < h.indexLabelTextBlock.y ? r++ : D++);
                  r = (B / (r + D || 1)) * D;
                  var D = -1 * (B - r),
                    I = (F = 0);
                  'right' === h.hemisphere
            ...
            if (
              ...
              (u = u = 0),
                ...
                0 < u &&
                  ...
                  Math.abs(h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - x.y) < z ||
                    Math.abs(h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 - x.y) <
                      z) &&
                ...
                0 < u &&
                  (!l &&
                    h.indexLabelText &&
                    ((r = 0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI ? -1 : 1),
                    0 === f(a, u * r) && f(a, 2 * r)),
      ...
      function h() {
        ...
        m.title &&
          (m.title.dockInsidePlotArea ||
            ('center' === m.title.horizontalAlign && 'center' === m.title.verticalAlign)) &&
          m.title.render();
        if (m.subtitles)
        ...
        m.legend &&
          (m.legend.dockInsidePlotArea ||
            ('center' === m.legend.horizontalAlign && 'center' === m.legend.verticalAlign)) &&
    ...
    m.prototype.renderFunnel = function (a) {
          ...
          for (e = 0; e < R.length; e++)
            0 == H[e].textBlock.text.length
              ...
              : ((a = R[e]),
                ...
                (d = H[e].width),
                b >= c
                  ? ((b = e != da ? (a.x4 + a.x3) / 2 - d / 2 : (a.x5 + a.x4) / 2 - d / 2),
      ...
      function h(a, b) {
        return (
          ...
          (0 > a ? (u.reversed ? ua - B : pa - B) : H[a].textBlock.y + H[a].height + ea)
        );
      }
      function m(a, b, c) {
        var d,
        ...
        for (var b, c, d, e, f = 0; f < R.length; f++)
          (e = 1 === H[f].lineThickness % 2 ? 0.5 : 0),
            ...
            H[f].isDirty ||
              ...
              a.setLineDash && a.setLineDash(I(H[f].lineDashType, H[f].lineThickness)),
              a.beginPath(),
              a.moveTo(b, c),
              a.lineTo(d, e),
              a.stroke());
      ...
      function w(a) {
        ...
        L.legend &&
          (L.legend.dockInsidePlotArea ||
            ('center' === L.legend.horizontalAlign && 'center' === L.legend.verticalAlign)) &&
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        if (0 != u.length && u.dataPoints && u.visible && 0 !== y.length) {
          ...
          if (-1 !== S) {
            if (u.reversed) for (A.push(W), G = S.length - 1; 0 < G; G--) (W += S[G]), A.push(W);
            else for (G = 0; G < S.length; G++) (W += S[G]), A.push(W);
            if (u.reversed)
              for (G = 0; G < S.length; G++)
                A[G] < Y
                  ? (a.push(M), D.push(ba), (da = G))
                  : (a.push((A[G] - pa + ca * V) / ca), D.push((A[G] - pa + ga * $) / ga));
            else
              for (G = 0; G < S.length; G++)
                A[G] < Y
                  ? (a.push((A[G] - pa + ca * V) / ca), D.push((A[G] - pa + ga * $) / ga), (da = G))
                  : (a.push(M), D.push(ba));
            ...
            for (G = 0; G < y.length; G++)
              y[G].exploded && ((S = !0), u.reversed ? Z.push(y.length - 1 - G) : Z.push(G));
            ...
            for (G = 0; G < R.length; G++) (z = R[G]), ta(P, z, u.fillOpacity), ja.push(z.y1);
            w(P);
            F &&
              u.visible &&
    ...
    m.prototype.replaceKeywordsWithValue = function (a, d, c, b, e) {
      ...
      if (
        ...
        do {
          ...
          a = a.replace(
            '#total',
            ha(h, c.yValueFormatString ? c.yValueFormatString : '#,##0.########', f._cultureInfo)
          );
    ...
    P.prototype.setLayout = function () {
      var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart,
        ...
        l = 0,
        h = (this.markerMargin =
          this.chart.options.legend && !r(this.chart.options.legend.markerMargin)
        ...
        for (var k = l[r], n = 0, p = 0; p < k.items.length; p++) {
          ...
          if ('line' === q.chartType || 'stepLine' === q.chartType || 'spline' === q.chartType)
            (this.ctx.strokeStyle = q.lineColor),
              ...
              this.ctx.beginPath(),
              this.ctx.moveTo(g - 0.1 * this.lineHeight, m + this.lineHeight / 2),
              this.ctx.lineTo(g + 0.85 * this.lineHeight, m + this.lineHeight / 2),
              this.ctx.stroke(),
          ...
          ? ((n = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x)),
            (n =
              1 < n
                ? Math.min(
                    Math.max(
                      (((this.dataPoints.length - 1) / n) * Math.log(a / this.dataPoints[0].x)) >>
                        0,
                      0
                    ),
          ...
          : ((n = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x),
            (n =
              0 < n
                ? Math.min(
                    Math.max(
                      (((this.dataPoints.length - 1) / n) * (a - this.dataPoints[0].x)) >> 0,
                      0
                    ),
                    this.dataPoints.length
                  )
          ...
          if (q) {
            switch (this.type) {
              ...
              case 'scatter':
                ...
                m <= w &&
                  b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: m });
                q = Math.abs(q.x1 - a);
                q <= r ? (r = q) : 0 < l ? k++ : n++;
                m <= v / 2 && (h = !0);
                break;
              ...
              case 'pyramid':
                ...
                d > m.y1 &&
                  ...
                  (m.y6
                    ? d > m.y6
                      ? ((f = m.x6 + ((m.x5 - m.x6) / (m.y5 - m.y6)) * (d - m.y6)),
                        (m = m.x3 + ((m.x4 - m.x3) / (m.y4 - m.y3)) * (d - m.y3)))
                      : ((f = m.x1 + ((m.x6 - m.x1) / (m.y6 - m.y1)) * (d - m.y1)),
                        (m = m.x2 + ((m.x3 - m.x2) / (m.y3 - m.y2)) * (d - m.y2)))
                    : ((f = m.x1 + ((m.x4 - m.x1) / (m.y4 - m.y1)) * (d - m.y1)),
                      (m = m.x2 + ((m.x3 - m.x2) / (m.y3 - m.y2)) * (d - m.y2))),
                  a > f &&
                    a < m &&
                    (b.push({
              ...
              if (!this._labels[c].breaksLabelType) {
                ...
                if (
                  ...
                  if (
                    ...
                    (n =
                      (k - (m + a.fontSize / 2) * Math.cos((Math.PI / 180) * Math.abs(-25))) /
                    ...
                    if (r(this.options.labelWrap))
                      if (!r(this.options.labelMaxWidth))
                        ...
                        if (((b = (t.width + d.width) >> 0), (g = this.labelFontSize), q < f))
                          b - 2 * f > p &&
                            ((p = b - 2 * f),
                            b >= 2 * f && b < 2.2 * f
                              ? ((this.sessionVariables.labelMaxWidth = f),
                                ...
                                (this.sessionVariables.labelFontSize = r(this.options.labelFontSize)
                                  ? g
                          ...
                          w === c &&
                          ((0 === w &&
                            q + this._labels[w + 1].textBlock.measureText().width - 2 * f > p) ||
                          ...
                          (p =
                            0 === w
                              ? q + this._labels[w + 1].textBlock.measureText().width - 2 * f
                              : q + this._labels[w - 1].textBlock.measureText().width - 2 * f),
                            (this.sessionVariables.labelFontSize = r(this.options.labelFontSize)
                              ? g
                              : this.options.labelFontSize),
                  ...
                  (this.sessionVariables.labelMaxHeight = this.labelWrap
                    ? (k - n * Math.sin((Math.PI / 180) * Math.abs(this.labelAngle))) /
                      Math.cos((Math.PI / 180) * Math.abs(this.labelAngle))
                    : 1.5 * this.labelFontSize),
                  r(this.options.labelWrap))
                    ? r(this.options.labelWrap) &&
        ...
        if (q[g] && q[g].scaleBreaks && q[g].scaleBreaks._appliedBreaks.length)
          for (
            ...
            t[v].endValue < q[g].viewportMinimum ||
              (r(q[g].scaleBreaks.firstBreakIndex) && (q[g].scaleBreaks.firstBreakIndex = v),
              t[v].startValue >= q[g].viewPortMinimum && (q[g].scaleBreaks.lastBreakIndex = v));
      for (
        var w = (v = 0),
          u = 0,
          y = 0,
        ...
        for (var y = [], x = [], B = [], D = [], K = [], N = [], O = [], P = []; 4 > v; ) {
          ...
          if (c && 0 < c.length)
            for (B = [], g = R = 0; g < c.length; g++)
              B.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)),
                (R += B[g]),
            ...
            for (g = 0; g < a.length; g++)
              a[g] &&
                ...
                !a[g] ||
                  ...
                  ((h = 0),
                  0 < a[g].labelAngle
                    ? E + u > m && (h += 0 < a[g].labelAngle ? E + u - m - $ : 0)
                    : 0 > a[g].labelAngle
                    ? z - w < l &&
                      z - w < a[g].viewportMinimum &&
                      (A = l - (M + a[g].tickLength + B + z - w + a[g].labelFontSize / 2))
                    : 0 === a[g].labelAngle &&
                      (E + u > m && (h = E + u / 2 - m - $),
                      z - w < l &&
                        z - w < a[g].viewportMinimum &&
                ...
                c[g] &&
                  ...
                  (M =
                    c[g]._labels && 0 < c[g]._labels.length
                      ...
                      : p),
                  (h = Math.round(f.y1 + Y + V < Math.max(M, p) ? Math.max(M, p) : f.y1 + Y + V)),
                  ...
                  'inside' === c[g].labelPlacement &&
                    ...
                    ((c[g].lineCoordinates.x1 =
                      c[g].lineCoordinates.x1 -
                      (B[g] - (c[g]._titleTextBlock ? c[g]._titleTextBlock.height : 0)) +
          ...
          if (0 < v) {
            ...
            if (b && 0 < b.length)
              for (g = 0; g < b.length; g++) J = P[v - 1][g] === P[v][g] ? !0 : !1;
            else J = !0;
          }
          if (t && F && I && J) break;
          v++;
        ...
        for (N = []; 4 > v; ) {
          ...
          if (a && 0 < a.length)
            for (A = [], g = X = 0; g < a.length; g++)
              A.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateWidth() : 0)),
                (X += A[g]),
                (e += a[g] && !n.isNavigator ? a[g].margin : 0);
          ...
          if (c && 0 < c.length)
            for (g = 0; g < c.length; g++)
              (c[g].lineCoordinates = {}),
                ...
                (m = Math.round(f.x2 - W - V > n.width - 10 ? n.width - 10 : f.x2 - W - V)),
                c[g].labelAutoFit &&
                  !r(y) &&
                  (0 < !a.length &&
                    (l =
                      0 > c[g].labelAngle
                        ...
                        : l),
                  0 < !d.length &&
                    (m = 0 < c[g].labelAngle ? m - x / 2 : 0 === c[g].labelAngle ? m - x / 2 : m)),
          ...
          if (b && 0 < b.length)
            for (g = 0; g < b.length; g++)
              (b[g].lineCoordinates = {}),
                (l = Math.round(f.x1 + X + e)),
                (m = Math.round(
                  f.x2 - W - V > b[g].chart.width - 10 ? b[g].chart.width - 10 : f.x2 - W - V
                )),
                b[g] &&
                  b[g].labelAutoFit &&
                  !r(B) &&
          ...
          if (b && 0 < b.length)
            for (z = [], g = Q = 0; g < b.length; g++)
              z.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateHeight() : 0)),
                (Q += z[g]),
                (Z += b[g].margin);
              ...
              b[g] &&
                ...
                'inside' === b[g].labelPlacement &&
                  ...
                  (b[g].lineCoordinates.y1 =
                    k - z[g] + (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)),
                (b[g].bounds = {
                  x1: l,
                  y1: h + (b[g].margin + G),
                  x2: m,
          ...
          if (a && 0 < a.length)
            for (g = 0; g < a.length; g++) {
                  ...
                  c[M] &&
                    ...
                    ((m =
                      0 > c[M].labelAngle
                        ...
                        ? Math.max(m, y / 2)
                        : m),
                    (l = 0 > c[M].labelAngle || 0 === c[M].labelAngle ? m - X : l));
              if (b && 0 < b.length)
                for (M = 0; M < b.length; M++)
                  b[M] && b[M].labelAutoFit && ((m = b[M].lineCoordinates.x1), (l = m - X));
              a[g].lineCoordinates = {
                x1: m - O,
                y1: h,
                x2: m - O,
              ...
              'inside' === a[g].labelPlacement &&
                ...
                ((a[g].lineCoordinates.x1 =
                  a[g].lineCoordinates.x1 -
                  (A[g] - (a[g]._titleTextBlock ? a[g]._titleTextBlock.height : 0)) +
          ...
          if (d && 0 < d.length)
            for (g = 0; g < d.length; g++) {
                  ...
                  c[M] &&
                    ...
                    ((m =
                      0 > c[M].labelAngle
                        ...
                        ? Math.max(m, y / 2)
                        : m),
                    (l = 0 > c[M].labelAngle || 0 === c[M].labelAngle ? m - W : l));
              if (b && 0 < b.length)
                for (M = 0; M < b.length; M++)
                  b[M] && b[M].labelAutoFit && ((m = b[M].lineCoordinates.x2), (l = m - W));
              d[g].lineCoordinates = {
                x1: m + P,
                y1: h,
                x2: m + P,
              ...
              'inside' === d[g].labelPlacement &&
                ...
                ((d[g].lineCoordinates.x1 =
                  d[g].lineCoordinates.x1 +
                  (w[g] - (d[g]._titleTextBlock ? d[g]._titleTextBlock.height : 0) - 2) -
    ...
    E.prototype.renderStripLinesOfThicknessType = function (a) {
      if (this.stripLines && 0 < this.stripLines.length && a) {
        for (
          var d = this, c, b = 0, e = 0, f = !1, l = !1, h = [], m = [], l = !1, b = 0;
        ...
        if ('axisX' === this.type && c) {
            ...
            (b / 1 <= a
              ...
              : ((this.interval =
                  b / (1 * K.yearDuration) <= a
                    ...
                    ? 4
                    : Math.floor(E.getNiceNumber(b / (a - 1), !0) / K.yearDuration)),
          ...
          if (null === this.viewportMinimum || isNaN(this.viewportMinimum))
            this.viewportMinimum =
              'axisX' === this.type ? e - l / 2 : Math.floor(e / this.interval) * this.interval;
          if (null === this.viewportMaximum || isNaN(this.viewportMaximum))
            this.viewportMaximum =
              'axisX' === this.type ? f + l / 2 : Math.ceil(f / this.interval) * this.interval;
    ...
    E.prototype.calculateLogarithmicAxisParameters = function () {
        ...
        for (l = 0; l < this.scaleBreaks._appliedBreaks.length; l++)
          if (
            ((!r(this.sessionVariables.newViewportMinimum) &&
              ...
              (!r(this.options.minimum) &&
                this.options.minimum >= this.scaleBreaks._appliedBreaks[l].startValue) ||
              (!r(this.options.viewportMinimum) &&
            ...
            ((!r(this.sessionVariables.newViewportMaximum) &&
              ...
              (!r(this.options.maximum) &&
                this.options.maximum <= this.scaleBreaks._appliedBreaks[l].endValue) ||
              (!r(this.options.viewportMaximum) &&
                this.viewportMaximum <= this.scaleBreaks._appliedBreaks[l].endValue))
          ) {
      ...
      1 === this.viewportMaximum &&
        ...
        this.options &&
          'undefined' === typeof this.options.interval &&
          ((this.interval = E.getNiceExponent(Math.ceil(Math.log(l) / d) / (a - 1))),
    ...
    ca.prototype.render = function (a, d, c) {
      ...
      this.labelFontSize = Math.abs(
        r(this.options.labelFontSize) ? this.parent.labelFontSize : this.labelFontSize
      );
      ...
      if (this.snapToDataPoint) {
        ...
        if ('xySwapped' === this.chart.plotInfo.axisPlacement) {
          ...
          if ('rangeBar' === n[0].dataSeries.type || 'error' === n[0].dataSeries.type)
            for (
              var w = Math.abs(a - this.parent.convertValueToPixel(n[A].dataPoint.y[0])),
                u = 0,
                t = 0;
              t < n.length;
              t++
              ...
              if (n[t].dataPoint.y && n[t].dataPoint.y.length)
                for (var y = 0; y < n[t].dataPoint.y.length; y++)
                  (u = Math.abs(a - this.parent.convertValueToPixel(n[t].dataPoint.y[y]))),
                    u < w && ((w = u), (A = t));
              else
                (u = Math.abs(a - this.parent.convertValueToPixel(n[t].dataPoint.y))),
                  u < w && ((w = u), (A = t));
          else if ('stackedBar' === n[0].dataSeries.type)
            for (
              var w = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)),
                x = (u = 0),
                t = (A = 0);
              t < n.length;
              t++
            ...
            for (
              ...
              if (n[t].dataPoint.y && n[t].dataPoint.y.length)
                ...
                (x += n[t].dataPoint.y),
                  (B = n[t].dataPoint.x.getTime ? n[t].dataPoint.x.getTime() : n[t].dataPoint.x),
                  (B = 100 * (x / n[t].dataSeries.plotUnit.dataPointYSums[B])),
                  (u = Math.abs(a - this.parent.convertValueToPixel(B))),
                  u < w && ((w = u), (A = t));
          else
            for (
              w = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), t = A = u = 0;
              t < n.length;
              t++
            )
              if (n[t].dataPoint.y && n[t].dataPoint.y.length)
          ...
          if ('bottom' === this.parent._position || 'top' === this.parent._position) {
            ...
            if (
              ...
              for (t = u = 0; t < y.dataPoint.y.length; t++)
                (u = Math.abs(a - this.parent.convertValueToPixel(y.dataPoint.y[t]))),
                  u < w && ((w = u), (b = t));
              m =
                1 === q.lineWidth % 2
              ...
              k.text = this.labelFormatter
                ...
                ? ha(r(c) ? y.dataPoint.y[b] : c, this.valueFormatString, this.chart._cultureInfo)
                : this.label;
              ...
              k.text = this.labelFormatter
                ...
                : r(this.options.label)
                ? ha(r(c) ? y.dataPoint.y : c, this.valueFormatString, this.chart._cultureInfo)
                : this.label;
              ...
              k.text = this.labelFormatter
                ...
                : r(this.options.label)
                ? ha(r(c) ? B : c, this.valueFormatString, this.chart._cultureInfo)
                : this.label;
            } else
              (m =
                1 === q.lineWidth % 2
            ...
            if (B) {
              if ('axisX' === this.parent.type)
                for (
                  t = this.parent.convertPixelToValue({ y: d }), w = null, A = 0;
              ...
              'dateTime' === this.parent.valueType
                ...
                : 'number' === this.parent.valueType &&
                  (k.text = this.labelFormatter
                    ...
                    : r(this.options.label)
                    ? ha(y.dataPoint.x, this.valueFormatString, this.chart._cultureInfo)
                    : this.label);
          ...
          if (
            ...
            for (
              w = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y[0])), t = u = 0;
              t < n.length;
              t++
            )
              if (n[t].dataPoint.y && n[t].dataPoint.y.length)
                for (y = 0; y < n[t].dataPoint.y.length; y++)
                  (u = Math.abs(d - this.parent.convertValueToPixel(n[t].dataPoint.y[y]))),
                    u < w && ((w = u), (A = t));
              else
                (u = Math.abs(d - this.parent.convertValueToPixel(n[t].dataPoint.y))),
                  u < w && ((w = u), (A = t));
          else if (
            ...
            for (
              w = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), t = x = u = 0;
              t < n.length;
              t++
            )
              if (n[t].dataPoint.y && n[t].dataPoint.y.length)
            ...
            for (
              w = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), t = u = 0;
              t < n.length;
              t++
            )
              if (n[t].dataPoint.y && n[t].dataPoint.y.length)
          ...
          if (
            ...
            for (t = u = 0; t < y.dataPoint.y.length; t++)
              (u = Math.abs(d - this.parent.convertValueToPixel(y.dataPoint.y[t]))),
                u < w && ((w = u), (b = t));
            v =
              1 === q.lineWidth % 2
                ? (this.parent.convertValueToPixel(y.dataPoint.y[b]) << 0) + 0.5
            ...
            'waterfall' === this.parent.dataSeries[A].type
              ? ((v =
                ...
                (k.text = this.labelFormatter
                  ...
                  : r(this.options.label)
                  ? ha(
                      r(c) ? y.dataSeries.dataPointEOs[y.index].cumulativeSum : c,
                      this.valueFormatString,
              ...
              : ((v =
                  1 === q.lineWidth % 2
                    ? (r(a) ? d : this.parent.convertValueToPixel(y.dataPoint.y) << 0) + 0.5
                    : r(a)
                    ? d
                    : this.parent.convertValueToPixel(y.dataPoint.y) << 0),
                (k.text = this.labelFormatter
          ...
          if (this.chart.axisX2)
            for (w = 0; w < this.chart.axisX2.length; w++) {
              ...
              for (b = 0; b < this.chart.axisX2[w].dataSeries.length; b++)
                (k = this.chart.axisX2[w].dataSeries[b].getDataPointAtX(h, c)) &&
                  0 <= k.index &&
    ...
    var N = {
        ...
        xClipAnimation: function (a, d) {
          if (0 !== a) {
            ...
            c.save();
            0 < a &&
              c.drawImage(b, 0, 0, b.width * a, b.height, 0, 0, (b.width * a) / la, b.height / la);
            c.restore();
          }
        },
